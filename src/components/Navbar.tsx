  ...
  return (
    <nav className="relative bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 shadow-2xl sticky top-0 z-50 backdrop-blur-md border-b border-purple-300/20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <button className="hidden sm:block relative p-2 sm:p-3 bg-gradient-to-r from-purple-600/20 to-indigo-600/20 backdrop-blur-sm rounded-lg sm:rounded-xl border border-purple-300/30 hover:scale-110 transition-all duration-300 group">
              <MdNotifications
                size={16}
                className="text-white/80 group-hover:text-white sm:w-4 sm:h-4"
              />
              <span className="absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-gradient-to-r from-pink-500 to-red-500 rounded-full flex items-center justify-center text-xs font-bold text-white animate-pulse">
                3
              </span>
            </button>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div className="absolute top-0 right-0 w-80 max-w-[90vw] h-full bg-gradient-to-b from-purple-900 via-indigo-900 to-blue-900 shadow-2xl border-l border-purple-300/20">
            {/* Mobile Menu Header */}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t border-purple-300/20 pt-6">
                <button className="flex items-center justify-between w-full p-4 rounded-xl hover:bg-gradient-to-r hover:from-pink-500/20 hover:to-purple-600/20 text-white/90 hover:text-white transition-all duration-300">
                  <div className="flex items-center space-x-3">
              ...
              <div className="border-t border-purple-300/20 pt-6 space-y-3">
                <Link to="/login" onClick={closeMobileMenu}>
                  <button className="w-full group relative p-4 text-sm font-semibold rounded-xl border-2 border-transparent bg-gradient-to-r from-purple-600/20 to-indigo-600/20 backdrop-blur-sm text-white/90 hover:text-white transition-all duration-300 transform hover:scale-105 overflow-hidden">
                    <span className="absolute inset-0 bg-gradient-to-r from-pink-500 to-purple-600 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
                ...
                <Link to="/register" onClick={closeMobileMenu}>
                  <button className="w-full group relative p-4 text-sm font-semibold rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:from-pink-600 hover:to-purple-700 shadow-lg hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-105 overflow-hidden">
                    <span className="absolute inset-0 bg-gradient-to-r from-white/0 to-white/20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></span>
                    <span className="relative flex items-center justify-center space-x-2">
                      <FaTicketAlt size={14} />
